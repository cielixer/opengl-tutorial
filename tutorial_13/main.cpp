...
int main( void )
{
	...
	GLuint programID = LoadShaders( "res/shaders/NormalMapping.vert", "res/shaders/NormalMapping.frag" );
	...
	// Load the texture
	GLuint DiffuseTexture = loadDDS("res/imgs/diffuse.DDS");
	GLuint NormalTexture = loadBMP_custom("res/imgs/normal.bmp");
	GLuint SpecularTexture = loadDDS("res/imgs/specular.DDS");
	...
	bool res = loadOBJ("res/models/cylinder.obj", vertices, uvs, normals);
